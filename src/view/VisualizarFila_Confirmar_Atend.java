	...
	public VisualizarFila_Confirmar_Atend() {
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String cpfC = textField.getText();
				boolean verificador = false;
				if(pessoaDao.findByCpf(cpfC) != null) {
					verificador = true;
				}
					if (confirmarRadioButton.isSelected()) {
						if(textField.getText().isEmpty()) {
							JOptionPane.showMessageDialog(null, "Necessário preencher o campo!!");
						}
					else {
						if (verificador == true) {
							...
							JOptionPane.showMessageDialog(null, "CPF não encontrado, digite novamente.");
						}
					}
					} 
